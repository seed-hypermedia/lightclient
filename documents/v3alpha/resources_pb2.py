...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PUSHRESOURCESTOPEERREQUEST']._serialized_end=599
  _globals['_RESOURCES']._serialized_start=602
  _globals['_RESOURCES']._serialized_end=840

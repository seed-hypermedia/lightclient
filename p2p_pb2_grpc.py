...
class P2PStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Handshake = channel.unary_unary(
                ...
                request_serializer=p2p__pb2.HandshakeInfo.SerializeToString,
                response_deserializer=p2p__pb2.HandshakeInfo.FromString,
                )
        self.ListObjects = channel.unary_unary(
                '/com.mintter.p2p.v1alpha.P2P/ListObjects',
                request_serializer=p2p__pb2.ListObjectsRequest.SerializeToString,
                response_deserializer=p2p__pb2.ListObjectsResponse.FromString,
                )
        self.RequestInvoice = channel.unary_unary(
                '/com.mintter.p2p.v1alpha.P2P/RequestInvoice',
                request_serializer=p2p__pb2.RequestInvoiceRequest.SerializeToString,
                response_deserializer=p2p__pb2.RequestInvoiceResponse.FromString,
                )
...
def add_P2PServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Handshake': grpc.unary_unary_rpc_method_handler(
                    servicer.Handshake,
                    request_deserializer=p2p__pb2.HandshakeInfo.FromString,
                    response_serializer=p2p__pb2.HandshakeInfo.SerializeToString,
            ),
            'ListObjects': grpc.unary_unary_rpc_method_handler(
                    servicer.ListObjects,
                    request_deserializer=p2p__pb2.ListObjectsRequest.FromString,
                    response_serializer=p2p__pb2.ListObjectsResponse.SerializeToString,
            ),
            'RequestInvoice': grpc.unary_unary_rpc_method_handler(
                    servicer.RequestInvoice,
                    request_deserializer=p2p__pb2.RequestInvoiceRequest.FromString,
                    response_serializer=p2p__pb2.RequestInvoiceResponse.SerializeToString,
            ),
    }
...
class P2P(object):
    ...
    def Handshake(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/com.mintter.p2p.v1alpha.P2P/Handshake',
            p2p__pb2.HandshakeInfo.SerializeToString,
            p2p__pb2.HandshakeInfo.FromString,
    ...
    def ListObjects(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/com.mintter.p2p.v1alpha.P2P/ListObjects',
            p2p__pb2.ListObjectsRequest.SerializeToString,
            p2p__pb2.ListObjectsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RequestInvoice(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/com.mintter.p2p.v1alpha.P2P/RequestInvoice',
            p2p__pb2.RequestInvoiceRequest.SerializeToString,
            p2p__pb2.RequestInvoiceResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
